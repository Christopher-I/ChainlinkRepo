...
var Routes = function () {
  ...
  _createClass(Routes, [{
    ...
    value: function getRequestHandler(app, customHandler, customNexthandler) {
      var _this = this;

      var nextHandler = customNexthandler || app.getRequestHandler();
    ...
    value: function getRouter(Router) {
      ...
      Router.reloadRoute = wrap('reload');
      return Router;
    }
  }]);
